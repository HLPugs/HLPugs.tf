				...
				<div id="settings">
					...
					<div className="settingsSection">
						...
						<div className="settingsBody">
							...
							<label htmlFor="autoFavJoin">
								Auto-add to favorites when you join the site
							</label>
							<input id="autoFavPug" type="checkbox" />
							<label htmlFor="autoFavPug">
								Auto-add to favorites when a pug finishes
							</label>
						</div>
					</div>
					<div className="settingsSection">
						...
						<div className="settingsBody">
							...
							<label htmlFor="audioCues">
								Play audio cues (during ready-up phase, etc.)
							</label>
						</div>
					</div>
					<div className="settingsSection">
						...
						<div className="settingsBody">
							...
							<span className="hintText">
								Changes sounds that play on the site such as during ready-up
								phase, etc.
							</span>
						</div>
					</div>
					<div className="settingsSection">
						...
						<div className="settingsBody">
							...
							<label htmlFor="chatPings">
								Enable chat notifications when someone types @
